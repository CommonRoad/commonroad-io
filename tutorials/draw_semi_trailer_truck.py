...
def draw_semi_trailer_truck_icon(shape: SemiTrailerTruckShape):
    fig = plt.figure()
    rnd = MPRenderer()

    initial_state = InitialState(
        position=np.array([50.0, 100.0]), orientation=0, velocity=0, time_step=0
    )
...
shape_1 = SemiTrailerTruckShape.create_default()
draw_semi_trailer_truck_icon(shape_1)

truck_dims = TruckDimensions.create_default()
shape_2 = SemiTrailerTruckShape(
...
draw_semi_trailer_truck_icon(shape_2)
