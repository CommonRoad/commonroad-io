...
\begin{center} {\Huge\textbf{CommonRoad: Documentation of the Format} \\[0.3cm] \huge(Version 3.0)} \end{center}
\vspace{0.2cm}
...
<commonRoad commonRoadVersion='3.0' benchmarkID="static_benchmark_id" 
date="2022-02-01" author="Sebastian Maierhofer" 
affiliation="Technical University of Munich, Germany" source="OpenStreetMap (OSM)" 
sourceLink="https://www.openstreetmap.org"  license="GNU GPLv3">
    <location>
    	...
    </location>
    <lanelet id='10'>
...
\begin{lstlisting}[language=XML]
<?xml version="1.0" encoding="utf-8"?>
<commonRoad commonRoadVersion="3.0" benchmarkID="dynamic_benchmark_id" 
date="2022-02-01" author="Sebastian Maierhofer" 
affiliation="Technical University of Munich, Germany" 
source="Simulation of Urban MObility (SUMO)" timeStepSize="0.1"  
...
\item Additional root element attributes for link to scenario source and license
\end{itemize}
