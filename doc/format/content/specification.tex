...
Each element has a unique\footnote{Unique within the whole scenario.} ID (of type positive integer) making it possible to reference it.
...
\subsubsection{GeoTransformation Element}
