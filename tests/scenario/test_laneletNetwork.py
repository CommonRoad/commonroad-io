...
class TestMapInformation(unittest.TestCase):
    def test_initialization(self):
        mapInformation = MapInformation(
            "v3", "map_id", Time(12, 0, 1, 1, 2023), "author", "affiliation", "source"
        )
...
class TestLaneletNetwork(unittest.TestCase):
    def setUp(self):
        ...
        incoming_1 = IntersectionIncomingElement(
            2, {self.lanelet_id, 11}, {12, 13}, {14, 15}, {16, 17}, 18
        )
    ...
    def test_map_information_initialization(self):
        default_map_information = MapInformation(
            "2023a",
            "map_id",
            self.lanelet_network.information.date,
            "author",
            "affiliation",
            "source",
            "licence_name",
    ...
    def test_create_from_lanelet_network(self):
        ...
        incoming_element1 = IntersectionIncomingElement(
            8, {lanelet3.lanelet_id}, {lanelet1.lanelet_id}
        )
        ...
        intersection1 = Intersection(
            ...
            crossings={lanelet3.lanelet_id, lanelet2.lanelet_id},
        )
