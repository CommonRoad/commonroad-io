...
class TestIntersection(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self._incoming_1 = IncomingGroup(self._incoming_id_1, lanelets_1, 19, outgoing_right_1,
                                         outgoing_straight_1, outgoing_left_1, self._crossings_1)
        ...
        self._incoming_2 = IncomingGroup(self._incoming_id_2, lanelets_2, 29, outgoing_right_2,
                                         outgoing_straight_2, outgoing_left_2, self._crossings_2)
        ...
        self._incoming_3 = IncomingGroup(incoming_id_3, lanelets_3, 49, outgoing_right_3,
                                         outgoing_straight_3, outgoing_left_3, self._crossings_3)
    ...
    def test_equality(self):
        incoming_1 = IncomingGroup(2, {10, 11}, 19, {12, 13}, {14, 15}, {16, 17}, {1})
        incoming_2 = IncomingGroup(3, {20, 21}, 29, {22, 23}, {24, 25}, {26, 27}, {2})
        outgoing_1 = OutgoingGroup(19, {12, 13, 14, 15, 16, 17})
        outgoing_2 = OutgoingGroup(29, {22, 23, 24, 25, 26, 27})
        intersection_1 = Intersection(1, [incoming_1, incoming_2], [outgoing_1, outgoing_2])
        intersection_2 = Intersection(1, [incoming_1, incoming_2], [outgoing_1, outgoing_2])
...
class TestOutgoingGroup(unittest.TestCase):
    ...
    def test_equality(self):
        outgoingGroup_1 = OutgoingGroup(1, {1, 2, 3})

        outgoingGroup_2 = OutgoingGroup(1, {1, 2, 3})
        self.assertTrue(outgoingGroup_1 == outgoingGroup_2)

        outgoingGroup_2 = OutgoingGroup(2, {1, 2, 3})
        self.assertFalse(outgoingGroup_1 == outgoingGroup_2)

        outgoingGroup_2 = OutgoingGroup(2, {1, 2})
        self.assertFalse(outgoingGroup_1 == outgoingGroup_2)

        outgoingGroup_2 = OutgoingGroup(2)
        self.assertFalse(outgoingGroup_1 == outgoingGroup_2)

    def test_hash(self):
        outgoingGroup_1 = OutgoingGroup(1, {1, 2, 3})
        outgoingGroup_2 = OutgoingGroup(1, {1, 2, 3})
        self.assertEqual(hash(outgoingGroup_1), hash(outgoingGroup_2))

        outgoingGroup_2 = OutgoingGroup(1, {1, 2})
        self.assertNotEqual(hash(outgoingGroup_1), hash(outgoingGroup_2))
...
class TestIntersectionIncomingElement(unittest.TestCase):
    def test_initialization_IntersectionIncomingElement(self):
        ...
        self.assertEqual(incoming_1.crossings, crossings_1)
    ...
    def test_equality(self):
        incoming_1 = IncomingGroup(2, {10, 11}, 19, {12, 13}, {14, 15}, {16, 17}, {1})
        incoming_2 = IncomingGroup(2, {10, 11}, 19, {12, 13}, {14, 15}, {16, 17}, {1})
        self.assertTrue(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(1, {10, 11}, 19, {12, 13}, {14, 15}, {16, 17}, {1})
        self.assertFalse(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(2, {11, 11}, 19, {12, 13}, {14, 15}, {16, 17}, {1})
        self.assertFalse(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(2, {10, 11}, 19, {12, 17}, {14, 15}, {16, 17}, {1})
        self.assertFalse(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(2, {10, 11}, 19, {12, 13}, {5, 15}, {16, 17}, {1})
        self.assertFalse(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(2, {10, 11}, 19, {12, 13}, {14, 15}, {7, 17}, {1})
        self.assertFalse(incoming_1 == incoming_2)

        incoming_1 = IncomingGroup(2, {10, 11}, 19, None, {14, 15}, {16, 17}, {1})
        incoming_2 = IncomingGroup(2, {10, 11}, 19, None, {14, 15}, {16, 17}, {1})
        self.assertTrue(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(2, {10, 11}, 19, {1, 2, 3, 4}, {14, 15}, {16, 17}, {1})
        self.assertFalse(incoming_1 == incoming_2)

        incoming_2 = IncomingGroup(2, {10, 11}, 19, {12, 13}, {14, 15}, {16, 17}, {2})
        self.assertFalse(incoming_1 == incoming_2)
