...
class TestPlanningProblemSet(unittest.TestCase):
    ...
    def test_translate(self):
        ...
        self.assertAlmostEqual(
            problem_set.planning_problem_dict[1].goal.state_list[0].position.center.x,
            shape1.center.x + translation[0],
        )
        self.assertAlmostEqual(
            problem_set.planning_problem_dict[1].goal.state_list[0].position.center.y,
            shape1.center.y + translation[1],
        )
        self.assertAlmostEqual(
            problem_set.planning_problem_dict[1].goal.state_list[1].position.center.x,
            shape2.center.x + translation[0],
        )
        self.assertAlmostEqual(
            problem_set.planning_problem_dict[1].goal.state_list[1].position.center.y,
