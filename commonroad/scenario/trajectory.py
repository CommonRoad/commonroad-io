...
class Trajectory(IDrawable):
    ...
    def __init__(self, initial_time_step: int, state_list: List[TraceState]):
        ...
        self.state_list: List[TraceState] = state_list
