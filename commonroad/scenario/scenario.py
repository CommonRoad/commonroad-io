...
class Scenario(IDrawable):
    ...
    def __init__(self, dt: float, scenario_id: ScenarioID = ScenarioID(),
                 ...
                 location: Location = None, init_lanelet_network_rtree: bool = False):
        """
        ...
        :param init_lanelet_network_rtree: Boolean indicating whether rtree should be initialized in LaneletNetwork.
        """
        self.dt: float = dt
        assert isinstance(scenario_id, ScenarioID)
        self.scenario_id = scenario_id
        self.lanelet_network: LaneletNetwork = LaneletNetwork(init_rtree=init_lanelet_network_rtree)
