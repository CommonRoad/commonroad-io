...
class Scenario(IDrawable):
    ...
    def __eq__(self, other):
        ...
        scenario_eq = (
            ...
            and self.file_information == other._file_information
    ...
    def __hash__(self):
        return hash(
            (
                ...
                self._file_information.author,
                self.tags,
                self._file_information.affiliation,
                self._file_information.source,
            )
        )
    ...
    def remove_boundary(self, boundary: Union[List[Bound], Bound]):
        ...
        """
        assert isinstance(boundary, (list, Bound)), (
            "<Scenario/remove_boundary> argument "
    ...
    def remove_stop_line(self, stop_line: Union[List[StopLine], StopLine]):
        ...
        """
        assert isinstance(stop_line, (list, StopLine)), (
            "<Scenario/remove_stop_line> argument "
