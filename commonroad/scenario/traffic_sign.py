...
class TrafficSignElement:
    ...
    def __init__(self, traffic_sign_element_id: Union[TrafficSignID, TrafficSignIDZamunda, TrafficSignIDUsa,
                 TrafficSignIDSpain, TrafficSignIDGermany, TrafficSignIDChina, TrafficSignIDRussia],
...
class TrafficSignValue:
    ...
    def __eq__(self, other):
        ...
        return self._traffic_sign_id == other.traffic_sign_id and \
            self._traffic_sign_elements == other.traffic_sign_elements
    ...
    def traffic_sign_id(self, traffic_sign_id: int):
        assert isinstance(traffic_sign_id, int), '<TrafficSignValue/traffic_sign_id>: provided traffic sign id is' \
