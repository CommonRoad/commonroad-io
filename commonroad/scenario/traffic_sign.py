...
class TrafficSignIDGermany(enum.Enum):
    ...
    REDIRECTION_DIRECTION_SIGN_LEFT = '460-10'
    THREE_LANES_NO_ONCOMING_LANES = '521-31'
    FOUR_LANES_NO_ONCOMING_LANES = '521-32'
    FIVE_LANES_NO_ONCOMING_LANES = '521-33'
    RIGHT_LANE_MERGES = '531-10'
    LEFT_LANE_MERGES = '531-20'
    NO_PASSAGE_BARRIER = '600-38'
    OBSTRUCTION_MARKER = '605-10'
    OBSTRCUTION_MARKER_DIAGONAL = '605-20'
    ...
    GUIDANCE_PANEL_STRAIGHT = '629-20'
    GREEN_ARROW = '720'
