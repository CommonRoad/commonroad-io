...
class TestVisualization(unittest.TestCase):
    ...
    def test_intersection_plot(self):
        ...
        draw_object(scenario.lanelet_network, draw_params={
    ...
    def test_traffic_signs(self):
        ...
        draw_object(scenario.lanelet_network, draw_params=draw_params)
        ...
        with pytest.warns(None) as record:
            for value in TrafficSignIDGermany:
                ...
                draw_object(TrafficSign(traffic_sign_elements=[
                        TrafficSignElement(value, ['foo'])], **kwargs))
    ...
    def test_signal_states(self):
        ...
        for t in range(2):
            ...
            draw_object(scenario.obstacles, draw_params=draw_params)
            plt.autoscale()
            plt.axis('equal')
            plt.show()
