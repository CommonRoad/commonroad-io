...
MapID = _reflection.GeneratedProtocolMessageType('MapID', (_message.Message,), dict(
  DESCRIPTOR = _MAPID,
...
ScenarioID = _reflection.GeneratedProtocolMessageType('ScenarioID', (_message.Message,), dict(
...
ScenarioMetaInformation = _reflection.GeneratedProtocolMessageType('ScenarioMetaInformation', (_message.Message,), dict(
