...
# source: common/traffic_light_state.proto
...
TrafficLightStateEnum = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "common.traffic_light_state_pb2",
