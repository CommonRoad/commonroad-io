...
# source: dynamic/traffic_sign_value.proto
...
TrafficSignValue = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "dynamic.traffic_sign_value_pb2",
