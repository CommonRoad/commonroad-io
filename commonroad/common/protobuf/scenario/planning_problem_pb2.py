...
# source: scenario/planning_problem.proto
...
_GOALSTATE.fields_by_name["state"].message_type = common_dot_state__pb2._STATE
_PLANNINGPROBLEM.fields_by_name["initial_state"].message_type = common_dot_state__pb2._STATE
_PLANNINGPROBLEM.fields_by_name["goal_states"].message_type = _GOALSTATE
_PLANNINGPROBLEM.fields_by_name[
    "scenario_tags"
].message_type = scenario_dot_scenario__tags__pb2._SCENARIOTAGS
...
GoalState = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        ...
        "__module__": "scenario.planning_problem_pb2",
