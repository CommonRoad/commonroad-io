...
# source: commonroad/common/pb_scripts/common/traffic_light_state.proto
...
TrafficLightStateEnum = _reflection.GeneratedProtocolMessageType('TrafficLightStateEnum', (_message.Message,), {
  ...
  '__module__' : 'commonroad.common.pb_scripts.common.traffic_light_state_pb2'
