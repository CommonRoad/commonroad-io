...
class ScenarioInterface:
    ...
    """
    def __init__(self, scenario_meta_information: ScenarioMetaInformation, map_id: str, dynamic_id: str,
    ...
    def __eq__(self, other):
        ...
        return self._scenario_meta_information == other.scenario_meta_information and self._map_id == other.map_id and \
            self._dynamic_id == other.dynamic_id and self._planning_problems == other.planning_problems \
            and self._cooperative_planning_problems == other.cooperative_planning_problems

    def __hash__(self):
        return hash((self._scenario_meta_information, self._map_id, self._dynamic_id,
                     frozenset(self._planning_problems), frozenset(self._cooperative_planning_problems)))
    ...
    def cooperative_planning_problems(self,
                                      cooperative_planning_problems: Union[None, List[CooperativePlanningProblem]]):
        if cooperative_planning_problems is None:
            self._cooperative_planning_problems = []
        else:
            self._cooperative_planning_problems = cooperative_planning_problems
