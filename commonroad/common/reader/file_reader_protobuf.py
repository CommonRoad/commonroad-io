...
class CommonRoadFactory:
    ...
    def create_from_message(
        cls, commonroad_msg: commonroad_pb2.CommonRoad, lanelet_assignment: bool
        ...
        for static_obstacle_msg in commonroad_msg.static_obstacles:
            static_obstacle = StaticObstacleFactory.create_from_message(
                static_obstacle_msg, scenario.lanelet_network, lanelet_assignment
            )
            scenario.add_objects(static_obstacle)

        for dynamic_obstacle_msg in commonroad_msg.dynamic_obstacles:
            dynamic_obstacle = DynamicObstacleFactory.create_from_message(
                dynamic_obstacle_msg, scenario.lanelet_network, lanelet_assignment
            )
...
class TrafficSignElementFactory:
    ...
    def create_from_message(cls, traffic_sign_element_msg: traffic_sign_pb2.TrafficSignElement):
        if traffic_sign_element_msg.HasField("germany_element_id"):
            element_id = TrafficSignIDGermany[
                traffic_sign_pb2.TrafficSignIDGermanyEnum.TrafficSignIDGermany.Name(
                    traffic_sign_element_msg.germany_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("zamunda_element_id"):
            element_id = TrafficSignIDZamunda[
                traffic_sign_pb2.TrafficSignIDZamundaEnum.TrafficSignIDZamunda.Name(
            ...
            element_id = TrafficSignIDChina[
                traffic_sign_pb2.TrafficSignIDChinaEnum.TrafficSignIDChina.Name(
                    traffic_sign_element_msg.china_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("spain_element_id"):
            element_id = TrafficSignIDSpain[
                traffic_sign_pb2.TrafficSignIDSpainEnum.TrafficSignIDSpain.Name(
                    traffic_sign_element_msg.spain_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("russia_element_id"):
            element_id = TrafficSignIDRussia[
                traffic_sign_pb2.TrafficSignIDRussiaEnum.TrafficSignIDRussia.Name(
                    traffic_sign_element_msg.russia_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("argentina_element_id"):
            element_id = TrafficSignIDArgentina[
                traffic_sign_pb2.TrafficSignIDArgentinaEnum.TrafficSignIDArgentina.Name(
                    traffic_sign_element_msg.argentina_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("belgium_element_id"):
            element_id = TrafficSignIDBelgium[
                traffic_sign_pb2.TrafficSignIDBelgiumEnum.TrafficSignIDBelgium.Name(
                    traffic_sign_element_msg.belgium_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("france_element_id"):
            element_id = TrafficSignIDFrance[
                traffic_sign_pb2.TrafficSignIDFranceEnum.TrafficSignIDFrance.Name(
                    traffic_sign_element_msg.france_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("greece_element_id"):
            element_id = TrafficSignIDGreece[
                traffic_sign_pb2.TrafficSignIDGreeceEnum.TrafficSignIDGreece.Name(
                    traffic_sign_element_msg.greece_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("croatia_element_id"):
            element_id = TrafficSignIDCroatia[
                traffic_sign_pb2.TrafficSignIDCroatiaEnum.TrafficSignIDCroatia.Name(
                    traffic_sign_element_msg.croatia_element_id
                )
            ]
        elif traffic_sign_element_msg.HasField("italy_element_id"):
            element_id = TrafficSignIDItaly[
                traffic_sign_pb2.TrafficSignIDItalyEnum.TrafficSignIDItaly.Name(
...
class StaticObstacleFactory:
    ...
    def create_from_message(
        ...
        if lanelet_assignment is True:
            occ = shape.compute_occupancy(initial_state)
            initial_shape_lanelet_ids = set(lanelet_network.find_lanelet_by_occupancy(occ))
