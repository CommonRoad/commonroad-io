...
_CYCLE = _descriptor.Descriptor(
  name='Cycle',
  full_name='commonroad.Cycle',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='cycle_elements', full_name='commonroad.Cycle.cycle_elements', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='time_offset', full_name='commonroad.Cycle.time_offset', index=1,
...
_TRAFFICLIGHT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cycle', full_name='commonroad.TrafficLight.cycle', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='active', full_name='commonroad.TrafficLight.active', index=4,
...
Cycle = _reflection.GeneratedProtocolMessageType('Cycle', (_message.Message,), dict(
  DESCRIPTOR = _CYCLE,
  __module__ = 'traffic_light_pb2'
  # @@protoc_insertion_point(class_scope:commonroad.Cycle)
  ))
