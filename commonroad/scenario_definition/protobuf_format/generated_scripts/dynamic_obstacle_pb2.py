...
_DYNAMICOBSTACLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.DynamicObstacle.dynamic_obstacle_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="obstacle_type",
            full_name="commonroad.DynamicObstacle.obstacle_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="shape",
            full_name="commonroad.DynamicObstacle.shape",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="initial_state",
            full_name="commonroad.DynamicObstacle.initial_state",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.DynamicObstacle.trajectory_prediction",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.DynamicObstacle.set_based_prediction",
            index=5,
            number=6,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.DynamicObstacle.initial_signal_state",
            index=6,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="signal_series",
            full_name="commonroad.DynamicObstacle.signal_series",
            index=7,
            number=8,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="prediction",
            full_name="commonroad.DynamicObstacle.prediction",
            index=0,
            containing_type=None,
            fields=[],
        ),
