...
_GOALSTATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="state",
            full_name="commonroad.GoalState.state",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.GoalState.goal_position_lanelets",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
...
_PLANNINGPROBLEM = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.PlanningProblem.planning_problem_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="initial_state",
            full_name="commonroad.PlanningProblem.initial_state",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="goal_states",
            full_name="commonroad.PlanningProblem.goal_states",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
