...
_WEATHERENUM_WEATHER = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="SUNNY", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LIGHT_RAIN", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HEAVY_AIN", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FOG", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SNOW", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="HAIL", index=5, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_GEOTRANSFORMATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="geo_reference",
            full_name="commonroad.GeoTransformation.geo_reference",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="x_translation",
            full_name="commonroad.GeoTransformation.x_translation",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="y_translation",
            full_name="commonroad.GeoTransformation.y_translation",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="z_rotation",
            full_name="commonroad.GeoTransformation.z_rotation",
            index=3,
            number=4,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="scaling",
            full_name="commonroad.GeoTransformation.scaling",
            index=4,
            number=5,
            type=1,
            cpp_type=5,
...
_ENVIRONMENT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="time",
            full_name="commonroad.Environment.time",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="time_of_day",
            full_name="commonroad.Environment.time_of_day",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="weather",
            full_name="commonroad.Environment.weather",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="underground",
            full_name="commonroad.Environment.underground",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
...
_LOCATION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="geo_name_id",
            full_name="commonroad.Location.geo_name_id",
            index=0,
            number=1,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="gps_latitude",
            full_name="commonroad.Location.gps_latitude",
            index=1,
            number=2,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            name="gps_longitude",
            full_name="commonroad.Location.gps_longitude",
            index=2,
            number=3,
            type=1,
            cpp_type=5,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.Location.geo_transformation",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="environment",
            full_name="commonroad.Location.environment",
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
GeoTransformation = _reflection.GeneratedProtocolMessageType(
    "GeoTransformation",
    (_message.Message,),
    dict(
