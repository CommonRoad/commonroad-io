...
_ENVIRONMENTOBSTACLE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="commonroad.EnvironmentObstacle.environment_obstacle_id",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="obstacle_type",
            full_name="commonroad.EnvironmentObstacle.obstacle_type",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="obstacle_shape",
            full_name="commonroad.EnvironmentObstacle.obstacle_shape",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
