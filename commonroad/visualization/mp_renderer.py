...
class MPRenderer(IRenderer):
    ...
    def draw_list(self, drawable_list: List[IDrawable], draw_params: Union[ParamServer, List[dict], dict, None] = None,
        ...
        :param draw_params: parameters for plotting given by a nested dict
            that recreates the structure of an object or a ParamServer object. Either a single object may be passed or
            a list with the same length as the list of drawables, containing specific parameters for the respective
            object.
        ...
        if not isinstance(draw_params, list):
            draw_params = itertools.repeat(draw_params, len(drawable_list))
