...
class LineDataUnits(Line2D):
    ...
    #             scale0 = ((trans((1, self._dashes_data[0])) - trans((0,
    #             0))) * ppd)[1]
    #             scale1 = ((trans((1, self._dashes_data[1])) - trans((0,
    #             0))) * ppd)[1]
    ...
    _linewidth = property(_get_lw,
                          _set_lw)  # _dashes = property(_get_dashes,
    # _set_dashes)
...
def collect_center_line_colors(lanelet_network: LaneletNetwork,
    ...
    def update_state_dict(new_dict: Dict[int, TrafficLightState]):
        """ Updates state in dict. If new_state is inactive, an existing
