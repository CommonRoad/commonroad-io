...
class MPRenderer:
    ...
    def draw_dynamic_obstacle(self, obj: DynamicObstacle, draw_params: dict,
        ...
        if draw_shape:
            ...
            #  occ.shape.vertices[1]])  #  #                            if
            #  hasattr(sig,  #  #  #  'flashing_blue_lights') and \  #  #  #
    ...
    for i_lanelet, lanelet in enumerate(lanelets):
        ...
        if draw_border_vertices or draw_right_bound:
            ...
            if draw_line_markings and lanelet.line_marking_right_vertices is \
                    not LineMarking.UNKNOWN and lanelet.line_marking_right_vertices is not LineMarking.NO_MARKING:
                linestyle, dashes, linewidth_metres = line_marking_to_linestyle(
